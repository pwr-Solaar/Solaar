...
class ActionMenu:
    ...
    def _menu_create_rule(self, m, it, below=False) -> Gtk.MenuItem:
        ...
        menu_create_rule.connect(GtkSignal.ACTIVATE.value, self._menu_do_insert_new, m, it, _DIV.Rule, [], below)
    ...
    def _menu_wrap(self, m, it) -> Gtk.MenuItem:
        ...
        menu_sub_rule.connect(GtkSignal.ACTIVATE.value, self.menu_do_wrap, m, it, _DIV.Rule)
        menu_and.connect(GtkSignal.ACTIVATE.value, self.menu_do_wrap, m, it, _DIV.And)
        menu_or.connect(GtkSignal.ACTIVATE.value, self.menu_do_wrap, m, it, _DIV.Or)
