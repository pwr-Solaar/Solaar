...
HID_CONSUMERCODES = _NamedInts(
    ...
    AL_Integrated_Help_Center=0xA6,
    AL_Documents=0xA7,
    AL_Thesaurus=0xA8,
    AL_Dictionary=0xA9,
    AL_Desktop=0xAA,
    AL_Spell_Check=0xAB,
    AL_Grammar_Check=0xAC,
    AL_Wireless_Status=0xAD,
    AL_Keyboard_Layout=0xAE,
    AL_Virus_Protection=0xAF,
    AL_Encryption=0xB0,
    AL_Screen_Saver=0xB1,
    AL_Alarms=0xB2,
    AL_Clock=0xB3,
    AL_File_Browser=0xB4,
    AL_Power_Status=0xB5,
    AL_Image_Browser=0xB6,
    AL_Audio_Browser=0xB7,
    AL_Movie_Browser=0xB8,
    AL_Digital_Rights_Manager=0xB9,
    AL_Digital_Wallet=0xBA,
    AL_Instant_Messaging=0xBC,
    AL_OEM_Features___Tips__Tutorial_Browser=0xBD,
    AL_OEM_Help=0xBE,
    AL_Online_Community=0xBF,
    AL_Entertainment_Content_Browser=0xC0,
    AL_Online_Shopping_Browser=0xC1,
    AL_SmartCard_Information__Help=0xC2,
    AL_Market_Monitor__Finance_Browser=0xC3,
    AL_Customized_Corporate_News_Browser=0xC4,
    AL_Online_Activity_Browser=0xC5,
    AL_Research__Search_Browser=0xC6,
    AL_Audio_Player=0xC7,
